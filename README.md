...
- [Better Auth with Drizzle and Neon in Astro](https://www.giorgiosaud.io/notebook/better-auth-drizzle-neon-astro/)
- [CSP Without unsafe-inline in Astro + Vercel](https://www.giorgiosaud.io/notebook/csp-without-unsafe-inline-astro-vercel/)
- [Web Push Notifications with Astro and Vercel](https://www.giorgiosaud.io/notebook/web-push-notifications-astro-vercel/)
- [Better Auth con Drizzle y Neon en Astro](https://www.giorgiosaud.io/es/cuaderno/better-auth-drizzle-neon-astro/)
- [CSP Sin unsafe-inline en Astro + Vercel](https://www.giorgiosaud.io/es/cuaderno/csp-without-unsafe-inline-astro-vercel/)
- [Web Push Notifications con Astro y Vercel](https://www.giorgiosaud.io/es/cuaderno/web-push-notifications-astro-vercel/)
- [Venezuela 51: State Refactoring and the Puerto Ordaz Hub](https://www.giorgiosaud.io/notebook/venezuela-51-state-refactoring-puerto-ordaz/)
- [Venezuela 51: El Refactoring del Estado y el Hub de Puerto Ordaz](https://www.giorgiosaud.io/es/cuaderno/venezuela-51-refactoring-estado-puerto-ordaz/)
- [Upgrading to Astro 6, Svelte 5, and Better Auth 1.6: What Broke and How I Fixed It](https://www.giorgiosaud.io/notebook/upgrading-astro-6-svelte-5-dependency-conflicts/)
- [Actualizando a Astro 6, Svelte 5 y Better Auth 1.6: Qué se rompió y cómo lo arreglé](https://www.giorgiosaud.io/es/cuaderno/upgrading-astro-6-svelte-5-dependency-conflicts/)
- [Chrome Built-in AI: The Summarizer API](https://www.giorgiosaud.io/notebook/2026-05-03-chrome-built-in-ai-summarizer/)
- [Chrome IA Integrada: La API Summarizer](https://www.giorgiosaud.io/es/cuaderno/2026-05-03-chrome-ia-integrada-api-summarizer/)
- [bunx vitest vs vitest in Bun Scripts](https://www.giorgiosaud.io/notebook/bunx-vitest-vs-vitest-in-bun-scripts/)
- [How to Mock astro:content in Vitest](https://www.giorgiosaud.io/notebook/how-to-mock-astro-content-in-vitest/)
- [Why vi.stubEnv Doesn&#39;t Work for import.meta.env.DEV](https://www.giorgiosaud.io/notebook/import-meta-env-dev-in-vitest/)
- [bunx vitest vs vitest en scripts de Bun](https://www.giorgiosaud.io/es/cuaderno/bunx-vitest-vs-vitest-in-bun-scripts/)
- [Cómo mockear astro:content en Vitest](https://www.giorgiosaud.io/es/cuaderno/how-to-mock-astro-content-in-vitest/)
- [Por qué vi.stubEnv no funciona con import.meta.env.DEV](https://www.giorgiosaud.io/es/cuaderno/import-meta-env-dev-in-vitest/)
- [Building a Claude API Load Indicator for Your Terminal](https://www.giorgiosaud.io/notebook/claude-api-load-indicator-terminal/)
- [Construyendo un Indicador de Carga de la API de Claude para tu Terminal](https://www.giorgiosaud.io/es/cuaderno/claude-api-load-indicator-terminal/)
- [Venezuela 2026: The &#39;Clean Install&#39; of a National Hardware](https://www.giorgiosaud.io/notebook/clean-install-venezuela/)
- [Venezuela 2026: El &#39;Clean Install&#39; del Hardware Nacional](https://www.giorgiosaud.io/es/cuaderno/venezuela-instalacion-limpia/)
- [Venezuela: Re-arquitecturando una Nación para la Inversión](https://www.giorgiosaud.io/es/cuaderno/venezuela-como-plataforma/)
- [The Planned Digital City: Puerto Ordaz as a Beta Test for Venezuela&#39;s Recovery](https://www.giorgiosaud.io/notebook/the-planned-city-of-the-future/)
- [La Ciudad Digital Planificada: Puerto Ordaz como Beta Test para la Recuperación de Venezuela](https://www.giorgiosaud.io/es/cuaderno/the-planned-city-of-the-future/)
- [Re-platforming Venezuela: A Solution Architect&#39;s Perspective](https://www.giorgiosaud.io/notebook/my-venezuelan-vision/)
- [Re-plataformando Venezuela: La Perspectiva de un Arquitecto de Soluciones](https://www.giorgiosaud.io/es/cuaderno/my-venezuelan-vision/)
- [Venezuela: Re-architecting a Nation for Global Investment](https://www.giorgiosaud.io/notebook/venezuela-as-a-platform/)
- [Browser Native AI: Chrome&#39;s Summarizer API](https://www.giorgiosaud.io/notebook/browser-native-ai-chrome-summarizer/)
- [Chrome Summarizer API 2026: Browser AI Goes Mainstream](https://www.giorgiosaud.io/notebook/chrome-summarizer-api-2026/)
- [Container Queries 2026: Production-Ready Component Design](https://www.giorgiosaud.io/notebook/container-queries-2026/)
- [CSS Anchor Positioning: The Future of UI Placement](https://www.giorgiosaud.io/notebook/css-anchor-positioning/)
- [CSS Carousels 2026: Native Scroll Markers Finally Here](https://www.giorgiosaud.io/notebook/css-carousels-2026/)
- [CSS Custom Properties 2026: @property Goes Mainstream](https://www.giorgiosaud.io/notebook/css-custom-properties-2026/)
- [CSS Grid &amp; Subgrid 2026: Universal Support Unlocks New Patterns](https://www.giorgiosaud.io/notebook/css-grid-subgrid-2026/)
- [CSS @layer 2026: Universal Support for Cascade Control](https://www.giorgiosaud.io/notebook/css-layers-2026/)
- [CSS Scroll Animations 2026: View Timeline Now Stable](https://www.giorgiosaud.io/notebook/css-scroll-animations-2026/)
- [Islands Architecture: Multi-Framework Components](https://www.giorgiosaud.io/notebook/islands-architecture-multi-framework/)
- [Implementing llms.txt: Make Your Site AI-Friendly](https://www.giorgiosaud.io/notebook/llms-txt-implementation/)
- [Self-Healing URLs in Astro 5: Content Collections Update](https://www.giorgiosaud.io/notebook/self-healing-urls-astro-5/)
- [Server Actions in Astro: Forms Done Right](https://www.giorgiosaud.io/notebook/server-actions-astro-forms/)
...
- [View Transitions API: Navegación Fluida entre Páginas](https://www.giorgiosaud.io/es/cuaderno/api-view-transitions/)
- [Islands Architecture: Componentes Multi-Framework](https://www.giorgiosaud.io/es/cuaderno/arquitectura-islas-multi-framework/)
- [CSS @layer 2026: Soporte Universal para Control de Cascada](https://www.giorgiosaud.io/es/cuaderno/capas-css-2026/)
- [CSS Carousels 2026: Scroll Markers Nativos Por Fin Aquí](https://www.giorgiosaud.io/es/cuaderno/carruseles-css-2026/)
