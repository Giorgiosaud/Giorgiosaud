...
- [Introducing the New Summary API in Browsers](https://giorgiosaud.io/es/cuaderno/introduccion-a-api-summary/)
- [Introducing the New Summary API in Browsers](https://giorgiosaud.io/notebook/introducing-summary-api-browsers/)
- [MCP&#39;s Role in the near Future of AI Technology](https://giorgiosaud.io/notebook/mcps-role-in-the-future-of-ai-technology/)
- [Lo que espero de MCP en el nuevo mundo de la IA](https://giorgiosaud.io/es/cuaderno/rol-de-mcp-en-el-futuro-cercano/)
- [Effortless Grids for Responsive Layouts Made Easy](https://giorgiosaud.io/notebook/grid-simplified/)
- [Grillas Sin Esfuerzo: Crea Layouts Responsivos Fácilmente](https://giorgiosaud.io/es/cuaderno/sistema-de-grilla-simplificado/)
- [Lo que se viene: Carruseles sin JS casi aqui ya en chrome](https://giorgiosaud.io/es/cuaderno/carouseles-y-scroll-marker/)
- [CSS Carousels Without JavaScript: A Guide](https://giorgiosaud.io/notebook/carousel-scroll-marker/)
