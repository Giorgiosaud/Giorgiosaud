...
- [bunx vitest vs vitest in Bun Scripts](https://giorgiosaud.io/notebook/bunx-vitest-vs-vitest-in-bun-scripts/)
- [How to Mock astro:content in Vitest](https://giorgiosaud.io/notebook/how-to-mock-astro-content-in-vitest/)
- [Why vi.stubEnv Doesn&#39;t Work for import.meta.env.DEV](https://giorgiosaud.io/notebook/import-meta-env-dev-in-vitest/)
- [bunx vitest vs vitest en scripts de Bun](https://giorgiosaud.io/es/cuaderno/bunx-vitest-vs-vitest-in-bun-scripts/)
- [Cómo mockear astro:content en Vitest](https://giorgiosaud.io/es/cuaderno/how-to-mock-astro-content-in-vitest/)
- [Por qué vi.stubEnv no funciona con import.meta.env.DEV](https://giorgiosaud.io/es/cuaderno/import-meta-env-dev-in-vitest/)
- [Building a Claude API Load Indicator for Your Terminal](https://giorgiosaud.io/notebook/claude-api-load-indicator-terminal/)
- [Construyendo un Indicador de Carga de la API de Claude para tu Terminal](https://giorgiosaud.io/es/cuaderno/claude-api-load-indicator-terminal/)
- [Venezuela 2026: The &#39;Clean Install&#39; of a National Hardware](https://giorgiosaud.io/notebook/clean-install-venezuela/)
- [Venezuela 2026: El &#39;Clean Install&#39; del Hardware Nacional](https://giorgiosaud.io/es/cuaderno/venezuela-instalacion-limpia/)
- [Venezuela: Re-arquitecturando una Nación para la Inversión](https://giorgiosaud.io/es/cuaderno/venezuela-como-plataforma/)
- [The Planned Digital City: Puerto Ordaz as a Beta Test for Venezuela&#39;s Recovery](https://giorgiosaud.io/notebook/the-planned-city-of-the-future/)
- [La Ciudad Digital Planificada: Puerto Ordaz como Beta Test para la Recuperación de Venezuela](https://giorgiosaud.io/es/cuaderno/the-planned-city-of-the-future/)
- [Re-platforming Venezuela: A Solution Architect&#39;s Perspective](https://giorgiosaud.io/notebook/my-venezuelan-vision/)
- [Re-plataformando Venezuela: La Perspectiva de un Arquitecto de Soluciones](https://giorgiosaud.io/es/cuaderno/my-venezuelan-vision/)
- [Venezuela: Re-architecting a Nation for Global Investment](https://giorgiosaud.io/notebook/venezuela-as-a-platform/)
- [Container Queries 2026: Production-Ready Component Design](https://giorgiosaud.io/notebook/container-queries-2026/)
- [Chrome Summarizer API 2026: Browser AI Goes Mainstream](https://giorgiosaud.io/notebook/chrome-summarizer-api-2026/)
- [Browser Native AI: Chrome&#39;s Summarizer API](https://giorgiosaud.io/notebook/browser-native-ai-chrome-summarizer/)
- [CSS Anchor Positioning: The Future of UI Placement](https://giorgiosaud.io/notebook/css-anchor-positioning/)
- [CSS Carousels 2026: Native Scroll Markers Finally Here](https://giorgiosaud.io/notebook/css-carousels-2026/)
- [CSS Custom Properties 2026: @property Goes Mainstream](https://giorgiosaud.io/notebook/css-custom-properties-2026/)
- [CSS Grid &amp; Subgrid 2026: Universal Support Unlocks New Patterns](https://giorgiosaud.io/notebook/css-grid-subgrid-2026/)
- [CSS @layer 2026: Universal Support for Cascade Control](https://giorgiosaud.io/notebook/css-layers-2026/)
- [CSS Scroll Animations 2026: View Timeline Now Stable](https://giorgiosaud.io/notebook/css-scroll-animations-2026/)
- [Islands Architecture: Multi-Framework Components](https://giorgiosaud.io/notebook/islands-architecture-multi-framework/)
- [Implementing llms.txt: Make Your Site AI-Friendly](https://giorgiosaud.io/notebook/llms-txt-implementation/)
- [Self-Healing URLs in Astro 5: Content Collections Update](https://giorgiosaud.io/notebook/self-healing-urls-astro-5/)
- [Server Actions in Astro: Forms Done Right](https://giorgiosaud.io/notebook/server-actions-astro-forms/)
- [Sharing State Between Frameworks with Nanostores](https://giorgiosaud.io/notebook/sharing-state-nanostores/)
- [Type-Safe i18n: Deep Key Extraction in TypeScript](https://giorgiosaud.io/notebook/type-safe-i18n-typescript/)
- [View Transitions API: Smooth Page Navigation](https://giorgiosaud.io/notebook/view-transitions-api/)
...
- [API Summarizer de Chrome 2026: La IA del Navegador Se Vuelve Mainstream](https://giorgiosaud.io/es/cuaderno/api-summarizer-chrome-2026/)
...
- [CSS Carousels 2026: Scroll Markers Nativos Por Fin Aquí](https://giorgiosaud.io/es/cuaderno/carruseles-css-2026/)
...
- [CSS @layer 2026: Soporte Universal para Control de Cascada](https://giorgiosaud.io/es/cuaderno/capas-css-2026/)
- [CSS Scroll Animations 2026: View Timeline Ahora Estable](https://giorgiosaud.io/es/cuaderno/animaciones-scroll-css-2026/)
- [Islands Architecture: Componentes Multi-Framework](https://giorgiosaud.io/es/cuaderno/arquitectura-islas-multi-framework/)
- [Implementando llms.txt: Haz Tu Sitio Amigable para IA](https://giorgiosaud.io/es/cuaderno/implementacion-llms-txt/)
- [URLs Auto-Reparables en Astro 5: Actualización de Content Collections](https://giorgiosaud.io/es/cuaderno/urls-auto-reparables-astro-5/)
- [Server Actions en Astro: Formularios Bien Hechos](https://giorgiosaud.io/es/cuaderno/server-actions-formularios-astro/)
- [Compartiendo Estado Entre Frameworks con Nanostores](https://giorgiosaud.io/es/cuaderno/compartiendo-estado-nanostores/)
...
- [View Transitions API: Navegación Fluida entre Páginas](https://giorgiosaud.io/es/cuaderno/api-view-transitions/)
- [Modern Custom Properties with Defaults](https://giorgiosaud.io/notebook/custom-properties-with-defaults/)
- [Propiedades CSS con valores predeterminados](https://giorgiosaud.io/es/cuaderno/custom-properties-with-defaults/)
